...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Cducoin
else
  DOCKER_EXEC echo \> \$HOME/.cducoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/cducoin/cducoin/pull/18288#discussion_r433189350 for
  # details.
