...
(define* (make-cducoin-cross-toolchain target
                                       #:key
...
desirable for building Cducoin Core release binaries."
...
(define glibc-2.27/cducoin-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-cducoin-cross-toolchain target
                                                      #:base-libc glibc-2.27/cducoin-patched
