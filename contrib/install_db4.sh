...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the cducoin repository."
  exit 1
fi
...
# See https://github.com/cducoin/cducoin/issues/16064
...
echo 'When compiling cducoind, run `./configure` in the following way:'
echo
