...
cducoincore.org and cducoin.org and compares them.
...
WORKINGDIR = "/tmp/cducoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://cducoincore.org"
HOST2 = "https://cducoin.org"
VERSIONPREFIX = "cducoin-core-"
...
def main(args):
    ...
    if not success:
        print("cducoin.org failed to provide signature file, "
              "but cducoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("cducoin.org and cducoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Cducoin Core binary release "
