...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef CDUCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define CDUCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the cducoin network\n')
    ...
    g.write('#endif // CDUCOIN_CHAINPARAMSSEEDS_H\n')
