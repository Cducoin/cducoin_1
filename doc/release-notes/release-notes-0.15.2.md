Cducoin Core version *0.15.2* is now available from:

  <https://cducoincore.org/bin/cducoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in cducoin-tx (TheBlueMatt)
