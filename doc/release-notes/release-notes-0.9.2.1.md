Cducoin Core version 0.9.2.1 is now available from:

  https://cducoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 CDU to 0.01 CDU
...
- Fix "Start cducoin on system login"
