Cducoin Core version 0.13.2 is now available from:

  <https://cducoin.org/bin/cducoin-core-0.13.2/>
...
- #8908 `4a974b2` Update cducoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow cducoin-tx to create v2 transactions (cdudrak)
