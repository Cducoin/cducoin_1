Cducoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/cducoin/files/Cducoin/cducoin-0.5.4/
...
http://gitorious.org/cducoin/cducoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Cducoin-Qt notifications under Growl 1.3.
Increase required age of Cducoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCducoin properly when installing Cducoin-Qt over it. (Windows)
