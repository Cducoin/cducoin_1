Cducoin Core version 0.9.4 is now available from:

  https://cducoin.org/bin/0.9.4/
...
this update is incompatible with the Cducoin system and could lead to consensus
forks.

Cducoin Core released binaries from https://cducoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~cducoin/+archive/ubuntu/cducoin
- A third-party or self-compiled Cducoin Core

upgrade to Cducoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
