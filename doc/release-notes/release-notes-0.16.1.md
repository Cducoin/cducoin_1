Cducoin Core version 0.16.1 is now available from:

  <https://cducoincore.org/bin/cducoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting cducoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure cducoind processes are cleaned up when tests end (sdaftuar)
