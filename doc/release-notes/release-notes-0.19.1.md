...
Cducoin Core version 0.19.1 is now available from:

  <https://cducoincore.org/bin/cducoin-core-0.19.1/>
...
From Cducoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Cducoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Cducoin Core does not yet change appearance when
...
- #17488 fix "cducoind already running" warnings on macOS (fanquake)
