Cducoin Core version 0.10.4 is now available from:

  <https://cducoin.org/bin/cducoin-core-0.10.4/>
...
- #6953 `43c2789` Split cducoin-tx into its own package
- #6953 `dfe0d4d` Include cducoin-tx binary on Debian/Ubuntu
