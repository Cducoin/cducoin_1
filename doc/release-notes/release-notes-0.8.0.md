Cducoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/cducoin/files/Cducoin/cducoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Cducoin
...
New/changed settings (command-line or cducoin.conf file)
--------------------------------------------------------
