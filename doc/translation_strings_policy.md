...
This document provides guidelines for internationalization of the Cducoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cducoin_en.ts` remains unchanged.
