// Copyright (c) 2015-2020 The Cducoin Core developers
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<CducoinAmountField*>("payAmount")->setValue(amount);
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_cducoin-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_cducoin-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_cducoin-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = CducoinUnits::formatWithUnit(unit, balance, false, CducoinUnits::SeparatorStyle::ALWAYS);
    ...
    // Amount input
    CducoinAmountField* amountInput = receiveCoinsDialog.findChild<CducoinAmountField*>("reqAmount");
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_cducoin-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI(m_node);
