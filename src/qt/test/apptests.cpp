...
//! Entry point for CducoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &CducoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for CducoinGUI tests.
void AppTests::guiTests(CducoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &CducoinGUI::consoleShown, this, &AppTests::consoleTests);
