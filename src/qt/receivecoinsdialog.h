...
#ifndef CDUCOIN_QT_RECEIVECOINSDIALOG_H
#define CDUCOIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of cducoins */
...
#endif // CDUCOIN_QT_RECEIVECOINSDIALOG_H
