    ...
    platformStyle(_platformStyle)
{
    ...
    // normal cducoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying cducoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &CducoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
