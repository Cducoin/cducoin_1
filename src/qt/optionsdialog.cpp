    ...
    mapper(nullptr)
{
    ...
    ui->cducoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->cducoinAtStartup);
    ...
    ui->cducoinAtStartup->setToolTip(ui->cducoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->cducoinAtStartup->setText(ui->cducoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openCducoinConfButton->setToolTip(ui->openCducoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new CducoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->cducoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openCducoinConfButton_clicked()
{
