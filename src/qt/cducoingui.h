...
#ifndef CDUCOIN_QT_CDUCOINGUI_H
#define CDUCOIN_QT_CDUCOINGUI_H
...
/**
  Cducoin GUI main class. This class represents the main window of the Cducoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class CducoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit CducoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~CducoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a cducoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Cducoin Transaction from file or clipboard */
