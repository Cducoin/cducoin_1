...
#ifndef CDUCOIN_QT_GUIUTIL_H
#define CDUCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Cducoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "cducoin:" URI into recipient object, return true on successful parsing
