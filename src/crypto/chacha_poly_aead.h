...
#ifndef CDUCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define CDUCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@cducoin.
 *
 ...
 *
 * The chacha20-poly1305@cducoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@cducoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@cducoin are relatively fast in
...
#endif // CDUCOIN_CRYPTO_CHACHA_POLY_AEAD_H
