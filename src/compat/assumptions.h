...
#ifndef CDUCOIN_COMPAT_ASSUMPTIONS_H
#define CDUCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Cducoin cannot be compiled without assertions."
#endif
...
#endif // CDUCOIN_COMPAT_ASSUMPTIONS_H
