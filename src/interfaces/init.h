...
#ifndef CDUCOIN_INTERFACES_INIT_H
#define CDUCOIN_INTERFACES_INIT_H
...
//! (cducoin-gui, cducoin-node, cducoin-wallet, cducoind, cducoin-qt) and each
...
#endif // CDUCOIN_INTERFACES_INIT_H
