...
#ifndef CDUCOIN_INTERFACES_NODE_H
#define CDUCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a cducoin node (cducoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // CDUCOIN_INTERFACES_NODE_H
