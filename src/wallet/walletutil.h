...
#ifndef CDUCOIN_WALLET_WALLETUTIL_H
#define CDUCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! cducoin from opening the wallet, thinking it was newly created, and
...
#endif // CDUCOIN_WALLET_WALLETUTIL_H
