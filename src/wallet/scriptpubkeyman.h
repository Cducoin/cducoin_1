...
#ifndef CDUCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define CDUCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Cducoin Core wallet was originally a collection of unrelated private
...
#endif // CDUCOIN_WALLET_SCRIPTPUBKEYMAN_H
