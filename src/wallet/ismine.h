...
#ifndef CDUCOIN_WALLET_ISMINE_H
#define CDUCOIN_WALLET_ISMINE_H
 ...
 * https://github.com/cducoin/cducoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
