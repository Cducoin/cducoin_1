...
#ifndef CDUCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define CDUCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // CDUCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
