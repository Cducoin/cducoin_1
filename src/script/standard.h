...
#ifndef CDUCOIN_SCRIPT_STANDARD_H
#define CDUCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a cducoin address
 */
...
/**
 * Generate a Cducoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // CDUCOIN_SCRIPT_STANDARD_H
