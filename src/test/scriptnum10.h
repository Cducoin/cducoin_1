...
#ifndef CDUCOIN_TEST_SCRIPTNUM10_H
#define CDUCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Cducoin Core 0.10.0, for cross-comparison.
 */
public:
