...
{
    BOOST_CHECK(TestSplitHost("www.cducoincore.org", "www.cducoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.cducoincore.org]", "www.cducoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.cducoincore.org:80", "www.cducoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.cducoincore.org]:80", "www.cducoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8066", "127.0.0.1", 8066));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8066", "127.0.0.1", 8066));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8066", "::ffff:127.0.0.1", 8066));
    BOOST_CHECK(TestSplitHost("[::]:8066", "::", 8066));
    BOOST_CHECK(TestSplitHost("::8066", "::8066", 0));
    BOOST_CHECK(TestSplitHost(":8066", "", 8066));
    BOOST_CHECK(TestSplitHost("[]:8066", "", 8066));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8066", "127.0.0.1:8066"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8066", "[::]:8066"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
