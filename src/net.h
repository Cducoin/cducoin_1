...
#ifndef CDUCOIN_NET_H
#define CDUCOIN_NET_H
 ...
 * src/qt/guiutil.cpp and src/cducoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Cducoin’s Peer-to-Peer Network")
