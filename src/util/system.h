 ...
 */
#ifndef CDUCOIN_UTIL_SYSTEM_H
#define CDUCOIN_UTIL_SYSTEM_H
...
extern const char * const CDUCOIN_CONF_FILENAME;
extern const char * const CDUCOIN_SETTINGS_FILENAME;
