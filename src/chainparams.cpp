...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.cducoin.sipa.be"); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me"); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.cducoin.dashjr.org"); // Luke Dashjr
        vSeeds.emplace_back("seed.cducoinstats.com"); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.cducoin.jonasschnelli.ch"); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.cdu.petertodd.org"); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.cducoin.sprovoost.nl"); // Sjors Provoost
        vSeeds.emplace_back("dnsseed.emzy.de"); // Stephan Oeste
        vSeeds.emplace_back("seed.cducoin.wiz.biz"); // Jason Maurice
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.cducoin.jonasschnelli.ch");
        vSeeds.emplace_back("seed.tcdu.petertodd.org");
        vSeeds.emplace_back("seed.testnet.cducoin.sprovoost.nl");
