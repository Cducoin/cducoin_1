...
By default, cducoind will dump mempool on shutdown and
...
class MempoolPersistTest(CducoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent cducoind from writing mempool.dat to disk. Verify that `savemempool` fails")
