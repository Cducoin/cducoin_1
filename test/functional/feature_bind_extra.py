#!/usr/bin/env python3
# Copyright (c) 2014-2021 The Cducoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""
Test starting cducoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(CducoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that cducoind has bound on "::1" (for RPC) and "::" (for P2P).
