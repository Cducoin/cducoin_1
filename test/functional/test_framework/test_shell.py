...
class TestShell:
    """Wrapper Class for CducoinTestFramework.

    The TestShell class extends the CducoinTestFramework
    ...
    class __TestShell(CducoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by CducoinTestFramework child class.
            self.num_nodes = 1
