...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the CducoinTestFramework
    pass


class ExampleTest(CducoinTestFramework):
    # Each functional test is a subclass of the CducoinTestFramework class.
    ...
    def custom_method(self):
        ...
        CducoinTestFramework class so other tests can use it."""
