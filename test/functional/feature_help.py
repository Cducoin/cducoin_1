...
"""Verify that starting cducoin with -h works as expected."""

from test_framework.test_framework import CducoinTestFramework
from test_framework.util import assert_equal

class HelpTest(CducoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cducoin with -h for help text")
        ...
        self.log.info("Start cducoin with -version for version information")
        ...
        self.log.info("Start cducoind with -fakearg to make sure it does not start")
