...
class P2PPermissionsTests(CducoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].cducoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].cducoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
