#!/usr/bin/env python3
# Copyright (c) 2021-2021 The Cducoin Core developers
...
class I2PPorts(CducoinTestFramework):
    ...
    def run_test(self):
        ...
        addr = "zsxwyo6qcn3chqzwxnseusqgsnuw3maqnztkiypyfxtya4snkoka.b32.i2p:8066"
        raised = False
        try:
